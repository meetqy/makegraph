...
`旭日图` 和 `乐队座位图` 页面也已接入：`https://makegraph.org/charts/sunburst-chart` 与 `https://makegraph.org/charts/band-seating-chart`。对应的 OG 预览图路径已在代码中预留，后续可再补充到 `public/charts/`。
