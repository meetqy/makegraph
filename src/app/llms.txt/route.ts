...
- [Pareto Chart Maker](${siteUrl}/charts/pareto-chart): Rank categories, add a cumulative percentage line, and identify the key few causes behind most of the impact.
...
- [帕累托图制作工具](${siteUrl}/zh/charts/pareto-chart)
