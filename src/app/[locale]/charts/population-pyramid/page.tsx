...
import { PopulationPyramidMaker } from './_components/population-pyramid-maker';

const currentPath = '/charts/population-pyramid';
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'PopulationPyramid' });

  return {
    title: t('heroTitle').replace(/[.!。]+$/u, ''),
    description: t('heroDescription'),
    alternates: getMetadataAlternates('/charts/population-pyramid', locale),
    openGraph: {
      images: ['/charts/population-pyramid-og-image.png'],
    },
    twitter: {
      images: ['/charts/population-pyramid-og-image.png'],
    },
          ...
          <section className="py-16 first:pt-0">
            ...
            <div className="mt-12">
              <div className="flex w-full items-center justify-center overflow-hidden rounded-2xl border border-[#ebebeb] bg-[#fafafa]">
                <Image
                  src="/charts/population-pyramid-og-image.png"
