...
import { TreeMapChartMaker } from './_components/tree-map-chart-maker';

const currentPath = '/charts/tree-map-chart';
...
export default async function TreeMapChartPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
          ...
          <section className="py-16 first:pt-0">
            ...
            <div className="mt-12">
              <div className="flex w-full items-center justify-center overflow-hidden rounded-2xl border border-[#ebebeb] bg-[#fafafa]">
                <Image
                  src="/charts/tree-map-chart-og-image.png"
                  alt="Tree Map Chart Example"
                  width={1200}
                  height={630}
