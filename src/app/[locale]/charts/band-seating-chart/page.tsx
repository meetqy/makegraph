...
import { BandSeatingChartMaker } from './_components/band-seating-chart-maker';

const currentPath = '/charts/band-seating-chart';
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'BandSeatingChart' });
  ...
  return {
    ...
    openGraph: {
      images: ['/charts/band-seating-chart-og-image.png'],
    },
    twitter: {
      images: ['/charts/band-seating-chart-og-image.png'],
    },
...
export default async function BandSeatingChartPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
          ...
          <section className="py-16 first:pt-0">
            ...
            <div className="mt-12">
              <div className="flex w-full items-center justify-center overflow-hidden rounded-2xl border border-[#ebebeb] bg-[#fafafa]">
                <Image
                  src="/charts/band-seating-chart-og-image.png"
                  alt="Band Seating Chart Example"
                  width={1200}
                  height={630}
