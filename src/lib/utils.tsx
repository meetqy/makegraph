...
const CHART_LINK_PATTERNS: Array<[RegExp, string]> = [
  ...
  [/negative bar chart/gi, '/charts/negative-bar-chart'],
  [/marimekko chart/gi, '/charts/marimekko-chart'],
  [/mekko chart/gi, '/charts/marimekko-chart'],
  [/mosaic plot/gi, '/charts/marimekko-chart'],
  [/sunburst chart/gi, '/charts/sunburst-chart'],
  [/sunburst/gi, '/charts/sunburst-chart'],
  ...
  [
    /confidence interval area chart/gi,
    '/charts/confidence-interval-area-chart',
  ],
  [/confidence interval chart/gi, '/charts/confidence-interval-area-chart'],
  [/CI area chart/gi, '/charts/confidence-interval-area-chart'],
  ...
  [/交错正负轴标签柱状图/gi, '/charts/negative-bar-chart'],
  [/交错正负轴标签/gi, '/charts/negative-bar-chart'],
  [/马里梅科图/gi, '/charts/marimekko-chart'],
  [/马赛克图/gi, '/charts/marimekko-chart'],
  [/旭日图/gi, '/charts/sunburst-chart'],
  [/双柱状图/gi, '/charts/double-bar-chart'],
  [/矩形树图/gi, '/charts/tree-map-chart'],
  [/树图/gi, '/charts/tree-map-chart'],
  [/雷达图/gi, '/charts/radar-chart'],
  [/置信区间面积图/gi, '/charts/confidence-interval-area-chart'],
  [/置信区间图/gi, '/charts/confidence-interval-area-chart'],
