...
`Confidence Interval Area Chart`, `Correlation Matrix`, `Marimekko Chart`, `Sunburst Chart`, `Band Seating Chart`, `Pareto Chart`, and `Population Pyramid` are also available at `https://makegraph.org/charts/confidence-interval-area-chart`, `https://makegraph.org/charts/correlation-matrix-chart`, `https://makegraph.org/charts/marimekko-chart`, `https://makegraph.org/charts/sunburst-chart`, `https://makegraph.org/charts/band-seating-chart`, `https://makegraph.org/charts/pareto-chart`, and `https://makegraph.org/charts/population-pyramid`. Their OG preview image paths are reserved in code and can be added later under `public/charts/`.
