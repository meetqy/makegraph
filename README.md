...
`Correlation Matrix`, `Sunburst Chart`, `Band Seating Chart`, and `Population Pyramid` are also available at `https://makegraph.org/charts/correlation-matrix-chart`, `https://makegraph.org/charts/sunburst-chart`, `https://makegraph.org/charts/band-seating-chart`, and `https://makegraph.org/charts/population-pyramid`. Their OG preview image paths are reserved in code and can be added later under `public/charts/`.
